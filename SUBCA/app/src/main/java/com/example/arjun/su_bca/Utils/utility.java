...
public class utility {
    ...
    public static String accessLoveCalculator(String str) {
    ...
    public static String loveCalculator(String str1, String str2) {
    ...
    public static String showResult(int love) {
        if(love < 10 || love > 90) {
    ...
    public static int counter(String name, char x) {
        int count = 0;
